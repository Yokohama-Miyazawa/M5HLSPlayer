/*
  ...
  This program was made by modifying "AudioFileSourceHTTPSStream.h" of ESP8266Audio.
...
class AudioFileSourceHTTPSStream : public AudioFileSource
{
  ...
  public:
    ...
    AudioFileSourceHTTPSStream(const char *url, const char *rootca);
    virtual ~AudioFileSourceHTTPSStream() override;

    virtual bool open(const char *url) override;
    bool open(const char *url, const char *rootca);
